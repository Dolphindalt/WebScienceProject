...
<div class='container-wrapper'>
    ...
    <div class='container-content'>
        <form id='loginForm' method='post' name='loginForm' enctype='multipart/form-data' class='form-style'>
            <span><input class='form-input' type='text' name='username' id='username' maxlength="36" placeholder="Username" <?php if (isset($_POST['username'])) { echo "value='" . $_POST['username'] . "'"; }?> /></span>
